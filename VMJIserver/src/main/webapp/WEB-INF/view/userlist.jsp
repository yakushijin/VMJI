...
<html>
	...
	<script type="text/javascript">	<%@ include file="../../js/userlist.js" %>	</script>
	...
	<script type="text/javascript"> UserListInstance() </script>
	...
	<body>
		...
		<div class="mt-1">
			<div class="row">
				<div class="col-md-6" >
					<div class="Menu">ユーザ一覧</div>
				</div>
				<div class="col-md-6" >
					<button type="button" class="text-warning bg-info btn btn-pdefault btn-xs btn-sm" style="float:right" onclick=UserAddModal()>ユーザを追加</button>
				</div>
			</div>	
			<div id="grid">
