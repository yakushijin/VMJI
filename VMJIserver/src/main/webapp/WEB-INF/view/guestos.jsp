...
<html>
	...
	<input type="hidden" id ="json" value='<%=request.getAttribute("guestoslist") %>'>
	...
	<script type="text/javascript">	<%@ include file="../../js/guestos.js" %>	</script>
	...
	<script type="text/javascript"> GuestOsInstance() </script>
	...
	<body>
		...
		<div class="mt-1">
			...
			<div class="row">
				...
				<div class="col-md-6" >
					<button type="button" class="text-warning bg-info btn btn-pdefault btn-xs btn-sm" style="float:right" onclick=GuestOsMakeNew()>最新の状態に更新</button>
				</div>
			</div>
			<div id="grid">
